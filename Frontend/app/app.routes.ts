...
{
  path: 'fees/receipts',
  loadComponent: () => import('./features/fees/receipts/receipts.component').then(m => m.ReceiptsComponent),
  canActivate: [roleGuard(['Admin', 'Accountant']), licenseGuard]
},
{
...
},
{
  ...
  loadComponent: () => import('./features/attendance/register/register.component').then(m => m.AttendanceRegisterComponent),
  canActivate: [roleGuard(['Admin', 'Teacher']), licenseGuard]
},
{
